...
The goal of this assignment is to write simple Python code for four basic alignment methods. The code looks a bit like Java to make the structure clear. We will test how much time and memory they use, and discuss when to use which method.
